...
SHORT_DESCRIPTION="A concise one line description of the script"

# A Multiline description of the script.
LONG_DESCRIPTION=$(
    cat <<END
$SCRIPT is used to ... A longer, typically multi line description of the script.
            The second and following lines should be indented 12 spaces to make the --help
            formatting line up.
END
)
...
function _define_variables() {
    ...
    # and set default values if missing.
    # EXCESS_ARGS=("${ARGS[@]:1}")
